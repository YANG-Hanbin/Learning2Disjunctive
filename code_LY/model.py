...
class att_block(torch.nn.Module):
    ...
    def __init__(self,v_size,c_size,first_emb_size,multi_head=4,is_first=False):
        ...
        self.att1=attention_prop(first_emb_size*multi_head,first_emb_size*multi_head,first_emb_size*multi_head)
        ...
        self.att2=attention_prop(first_emb_size*multi_head,first_emb_size*multi_head,first_emb_size*multi_head)
...
class var_sorter(torch.nn.Module):
    ...
    def __init__(self,v_size,c_size,sample_sizes,multi_head=4,natt=2):
        ...
        self.att_lays.append(att_block(first_emb_size,first_emb_size,first_emb_size,multi_head=multi_head,is_first=True))
        for i in range(natt):
