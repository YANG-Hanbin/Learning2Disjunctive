...
instanceName = '50v-10'
cpt = NaiveCuttingPlaneTreeAlgorithm(instanceName,training=True, save_interval=20, maxIteration=50, OutputFlag = 0, Threads = 1, MIPGap = 0.0, TimeLimit = 300, number_branch_var = 2, normalization = 'SNC')
cpt.train_model_each_round()